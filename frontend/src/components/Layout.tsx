...
import { LayoutDashboard, Database, Boxes, Link as LinkIcon, Network, Settings, Search, Bell, UserCircle, PlayCircle, Save, CheckCircle2, Sparkles, Bot, Building2, Compass, Code, ChevronDown, ChevronRight, Shield, Newspaper, RefreshCw, MessageSquareText, FolderOpen } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'knowledgebase', label: '资讯库', icon: FolderOpen },
